 ...
 */
@Stateless
public class EvaluationresponsabiliteFacade extends AbstractFacade<Evaluationresponsabilite> implements EvaluationresponsabiliteFacadeLocal {
    ...
    public EvaluationresponsabiliteFacade() {
        super(Evaluationresponsabilite.class);
    }

    @Override
    public Long nextId() {
        try {
            Query query = em.createQuery("SELECT MAX(e.idevaluationresponsabilite) FROM Evaluationresponsabilite e");
    ...
    public Evaluationresponsabilite findByIdPersonnel(int idPeriode, int idSousPeriode, long idPersonnel, int idCritere) {
        ...
        if (!list.isEmpty()) {
            return (Evaluationresponsabilite) list.get(0);
        }
        return null;
    }
