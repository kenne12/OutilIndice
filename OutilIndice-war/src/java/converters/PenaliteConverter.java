 ...
 * @author USER
 */
@FacesConverter(value = "penaliteConverter")
public class PenaliteConverter implements Converter {

    @EJB
    private PenaliteFacadeLocal ejbFacade;
    ...
    public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
        ...
        if (object instanceof Penalite) {
            Penalite p = (Penalite) object;
            return getStringKey(p.getIdpenalite());
        } else {
