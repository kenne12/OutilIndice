 ...
 */
package controllers.penalite_indiv;
...
@ManagedBean
@SessionScoped
public class PenaliteIndivController extends AbstractPenaliteIndivController implements Serializable {

    public PenaliteIndivController() {
